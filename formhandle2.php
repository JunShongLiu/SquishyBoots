...
<form action="formhandle2.php" method="POST" id='projection'>
Table: 
...
<h3> Selection </h3>
Selection: <select name="row" class="form-control" size="5" id="text-three" required><option>Please choose from above</option></select><br>
Value: <input type="text" class="form-control" name="value" required><br>
...
<br><br>
<form methods="POST" action="formhandle2.php">
